						...
						vim.api.nvim_create_autocmd("FileType", {
							...
							callback = function()
								...
								map(
									...
									{ desc = "Move cursor to previous metadata tag", buffer = true }
								)
							end,
						})
					end,
